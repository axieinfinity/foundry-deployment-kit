...
abstract contract NetworkConfig {
  ...
  constructor() payable {
    ...
    _networkDataMap[Network.Goerli] = NetworkData(
      tryCreateFork(GOERLI_ALIAS, ChainId.GOERLI), ChainId.GOERLI, TESTNET_ENV_LABEL, GOERLI_DIR, GOERLI_ALIAS
    );
    ...
    _networkDataMap[Network.Local] =
      NetworkData(tryCreateFork(LOCAL_ALIAS, ChainId.LOCAL), ChainId.LOCAL, LOCAL_ENV_LABEL, LOCAL_DIR, LOCAL_ALIAS);
