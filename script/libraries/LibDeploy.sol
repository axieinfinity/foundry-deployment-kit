...
import { TransparentUpgradeableProxyV2 } from "../../src/TransparentUpgradeableProxyV2.sol";
import { TransparentUpgradeableProxyV4_9_5 } from "../../src/TransparentUpgradeableProxyV4_9_5.sol";

import { StdStyle } from "../../lib/forge-std/src/StdStyle.sol";
import { console } from "../../lib/forge-std/src/console.sol";
import { vm, vme } from "../utils/Constants.sol";
import { prankOrBroadcast } from "../utils/Utils.sol";
...
library LibDeploy {
  ...
  function _precompileProxyContracts() private pure {
    bytes memory dummy;
    dummy = type(TransparentUpgradeableProxyV2).creationCode;
    dummy = type(TransparentUpgradeableProxyV4_9_5).creationCode;
  }
}
